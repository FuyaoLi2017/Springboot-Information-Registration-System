...
public class UserController {
	...
	@PostMapping(
			consumes = { MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE}, // input data format
			produces = { MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE}  // output data format
			)
...
UserRest returnValue = new UserRest();
		...
		if (userDetails.getFirstName().isEmpty()) throw new NullPointerException("The objects is null");
	...
	public List<UserRest> getUsers(@RequestParam(value="page", defaultValue="0") int page,  // default page is in the very first
			@RequestParam(value="limit", defaultValue="2") int limit)  // two items in each page
	{
	...
	// http://localhost:8080/mobile-app-ws/users/jfhdjeufhdhdj/addresses
